...
void nightMode()
{
    ...
    //Full Body
        ...
        if(rain)
        {
            ...
            rainf();
            //PlaySound(TEXT("D:\\GraohicsProject\\AIUB\\Aiub\\rain-01.wav"), NULL,SND_FILENAME|SND_LOOP);
        }
}
...
void startscreen(void)
{
    ...
    drawstring(250,500,0.0,"COMPUTER GRAPHICS: AIUB CAMPUS VIEW");
    glColor3f(1,0.5,0);
    drawstring(100,400,0.0,"SUBMITTED BY:");
    glColor3f(1,1,1);
    drawstring(100,370,0.0,"MAHMUD HASAN              (17-33881-1)");
    drawstring(100,290,0.0,"LOKMAN,MOHAMMAD   (19-40406-1)");
    drawstring(100,210,0.0,"NABAJIT                  (19-40618-1)");
    drawstring(100,130,0.0,"NAFIS SIDDIQUE          (20-43218-1)");
    glColor3f(1,0.5,0);
    drawstring(700,400,0.0,"SUBMITTED TO:");
    glColor3f(1,1,1);
    drawstring(700,370,0.0,"ANEEM AL AHSAN RUPAI");
    glColor3f(0,1,0);
